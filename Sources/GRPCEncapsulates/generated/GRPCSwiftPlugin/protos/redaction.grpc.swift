...
extension EventStore_Client_Redaction_RedactionClientProtocol {
  public var serviceName: String {
    return "event_store.client.redaction.Redaction"
  }
  ...
  public func getEventPositions(
    ...
    return self.makeBidirectionalStreamingCall(
      ...
      interceptors: self.interceptors?.makeGetEventPositionsInterceptors() ?? [],
      handler: handler
    )
  }
  ...
  public func switchChunks(
    ...
    return self.makeBidirectionalStreamingCall(
      ...
      callOptions: callOptions ?? self.defaultCallOptions,
      interceptors: self.interceptors?.makeSwitchChunksInterceptors() ?? [],
      handler: handler
    )
  }
}
...
extension EventStore_Client_Redaction_RedactionAsyncClientProtocol {
  public static var serviceDescriptor: GRPCServiceDescriptor {
    return EventStore_Client_Redaction_RedactionClientMetadata.serviceDescriptor
  }
...
extension EventStore_Client_Redaction_RedactionAsyncClientProtocol {
  public func getEventPositions<RequestStream>(
    ...
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncResponseStream<EventStore_Client_Redaction_GetEventPositionResp> where RequestStream: Sequence, RequestStream.Element == EventStore_Client_Redaction_GetEventPositionReq {
  ...
  public func switchChunks<RequestStream>(
    _ requests: RequestStream,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncResponseStream<EventStore_Client_Redaction_SwitchChunkResp> where RequestStream: Sequence, RequestStream.Element == EventStore_Client_Redaction_SwitchChunkReq {
    return self.performAsyncBidirectionalStreamingCall(
      path: EventStore_Client_Redaction_RedactionClientMetadata.Methods.switchChunks.path,
      requests: requests,
      callOptions: callOptions ?? self.defaultCallOptions,
...
extension EventStore_Client_Redaction_RedactionProvider {
  public var serviceName: Substring {
    return EventStore_Client_Redaction_RedactionServerMetadata.serviceDescriptor.fullName[...]
  }
  ...
  public func handle(
    ...
    case "GetEventPositions":
      return BidirectionalStreamingServerHandler(
        ...
        interceptors: self.interceptors?.makeGetEventPositionsInterceptors() ?? [],
        observerFactory: self.getEventPositions(context:)
      )
    ...
    case "SwitchChunks":
      return BidirectionalStreamingServerHandler(
        ...
        interceptors: self.interceptors?.makeSwitchChunksInterceptors() ?? [],
        observerFactory: self.switchChunks(context:)
      )
...
extension EventStore_Client_Redaction_RedactionAsyncProvider {
  public static var serviceDescriptor: GRPCServiceDescriptor {
    return EventStore_Client_Redaction_RedactionServerMetadata.serviceDescriptor
  }
