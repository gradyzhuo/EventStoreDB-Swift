...
extension EventStore_Client_Operations_OperationsClientProtocol {
    ...
    public func startScavenge(
        ...
        makeUnaryCall(
            ...
            interceptors: interceptors?.makeStartScavengeInterceptors() ?? []
        )
    }
    ...
    public func stopScavenge(
        ...
        makeUnaryCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeStopScavengeInterceptors() ?? []
        )
    }
    ...
    public func shutdown(
        ...
        makeUnaryCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeShutdownInterceptors() ?? []
        )
    }
    ...
    public func mergeIndexes(
        ...
        makeUnaryCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeMergeIndexesInterceptors() ?? []
        )
    }
    ...
    public func resignNode(
        ...
        makeUnaryCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeResignNodeInterceptors() ?? []
        )
    }
    ...
    public func setNodePriority(
        ...
        makeUnaryCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeSetNodePriorityInterceptors() ?? []
        )
    }
    ...
    public func restartPersistentSubscriptions(
        ...
        makeUnaryCall(
            ...
            request: request,
            callOptions: callOptions ?? defaultCallOptions,
            interceptors: interceptors?.makeRestartPersistentSubscriptionsInterceptors() ?? []
        )
    }
}
...
extension EventStore_Client_Operations_OperationsAsyncClientProtocol {
    public static var serviceDescriptor: GRPCServiceDescriptor {
        EventStore_Client_Operations_OperationsClientMetadata.serviceDescriptor
    }
...
extension EventStore_Client_Operations_OperationsProvider {
    public var serviceName: Substring {
        EventStore_Client_Operations_OperationsServerMetadata.serviceDescriptor.fullName[...]
    }
    ...
    public func handle(
        ...
        case "StartScavenge":
            UnaryServerHandler(
                ...
                interceptors: interceptors?.makeStartScavengeInterceptors() ?? [],
                userFunction: startScavenge(request:context:)
            )
        ...
        case "StopScavenge":
            UnaryServerHandler(
                ...
                responseSerializer: ProtobufSerializer<EventStore_Client_Operations_ScavengeResp>(),
                interceptors: interceptors?.makeStopScavengeInterceptors() ?? [],
                userFunction: stopScavenge(request:context:)
            )
        ...
        case "Shutdown":
            UnaryServerHandler(
                ...
                interceptors: interceptors?.makeShutdownInterceptors() ?? [],
                userFunction: shutdown(request:context:)
            )
        ...
        case "MergeIndexes":
            UnaryServerHandler(
                ...
                responseSerializer: ProtobufSerializer<EventStore_Client_Empty>(),
                interceptors: interceptors?.makeMergeIndexesInterceptors() ?? [],
                userFunction: mergeIndexes(request:context:)
            )
        ...
        case "ResignNode":
            UnaryServerHandler(
                ...
                responseSerializer: ProtobufSerializer<EventStore_Client_Empty>(),
                interceptors: interceptors?.makeResignNodeInterceptors() ?? [],
                userFunction: resignNode(request:context:)
            )
        ...
        case "SetNodePriority":
            UnaryServerHandler(
                ...
                responseSerializer: ProtobufSerializer<EventStore_Client_Empty>(),
                interceptors: interceptors?.makeSetNodePriorityInterceptors() ?? [],
                userFunction: setNodePriority(request:context:)
            )
        ...
        case "RestartPersistentSubscriptions":
            UnaryServerHandler(
                ...
                responseSerializer: ProtobufSerializer<EventStore_Client_Empty>(),
                interceptors: interceptors?.makeRestartPersistentSubscriptionsInterceptors() ?? [],
                userFunction: restartPersistentSubscriptions(request:context:)
            )
...
extension EventStore_Client_Operations_OperationsAsyncProvider {
    public static var serviceDescriptor: GRPCServiceDescriptor {
        EventStore_Client_Operations_OperationsServerMetadata.serviceDescriptor
    }
