...
public struct EventStore_Client_Projections_CreateReq {
    ...
    public struct Options {
        ...
        public var mode: EventStore_Client_Projections_CreateReq.Options.OneOf_Mode?
            ...
            case continuous(EventStore_Client_Projections_CreateReq.Options.Continuous)
                ...
                public static func == (lhs: EventStore_Client_Projections_CreateReq.Options.OneOf_Mode, rhs: EventStore_Client_Projections_CreateReq.Options.OneOf_Mode) -> Bool {
                    ...
                    case (.oneTime, .oneTime): {
                            guard case let .oneTime(l) = lhs, case let .oneTime(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    case (.transient, .transient): {
                            guard case let .transient(l) = lhs, case let .transient(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    case (.continuous, .continuous): {
                            guard case let .continuous(l) = lhs, case let .continuous(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    default: false
                    }
    ...
    fileprivate var _options: EventStore_Client_Projections_CreateReq.Options?
}
...
public struct EventStore_Client_Projections_UpdateReq {
    ...
    public struct Options {
        ...
        public var emitOption: EventStore_Client_Projections_UpdateReq.Options.OneOf_EmitOption?
        ...
        public enum OneOf_EmitOption: Equatable {
            ...
            case noEmitOptions(EventStore_Client_Empty)
                ...
                public static func == (lhs: EventStore_Client_Projections_UpdateReq.Options.OneOf_EmitOption, rhs: EventStore_Client_Projections_UpdateReq.Options.OneOf_EmitOption) -> Bool {
                    ...
                    // enabled. https://github.com/apple/swift-protobuf/issues/1034
                    switch (lhs, rhs) {
                    case (.emitEnabled, .emitEnabled): {
                            guard case let .emitEnabled(l) = lhs, case let .emitEnabled(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    case (.noEmitOptions, .noEmitOptions): {
                            guard case let .noEmitOptions(l) = lhs, case let .noEmitOptions(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    default: false
                    }
    ...
    fileprivate var _options: EventStore_Client_Projections_UpdateReq.Options?
}
...
public struct EventStore_Client_Projections_DeleteReq {
    ...
    fileprivate var _options: EventStore_Client_Projections_DeleteReq.Options?
}
...
public struct EventStore_Client_Projections_StatisticsReq {
    ...
    public struct Options {
        ...
        public var mode: EventStore_Client_Projections_StatisticsReq.Options.OneOf_Mode?
        ...
        public enum OneOf_Mode: Equatable {
            ...
            case oneTime(EventStore_Client_Empty)
                ...
                public static func == (lhs: EventStore_Client_Projections_StatisticsReq.Options.OneOf_Mode, rhs: EventStore_Client_Projections_StatisticsReq.Options.OneOf_Mode) -> Bool {
                    ...
                    switch (lhs, rhs) {
                    case (.name, .name): {
                            guard case let .name(l) = lhs, case let .name(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    case (.all, .all): {
    ...
    fileprivate var _options: EventStore_Client_Projections_StatisticsReq.Options?
}
...
public struct EventStore_Client_Projections_StatisticsResp {
    ...
    private var _details: EventStore_Client_Projections_StatisticsResp.Details?
}
...
public struct EventStore_Client_Projections_StateReq {
    ...
    public struct Options {
        ...
        public var partition: String = .init()
    ...
    fileprivate var _options: EventStore_Client_Projections_StateReq.Options?
}
...
public struct EventStore_Client_Projections_StateResp {
    ...
    private var _state: SwiftProtobuf.Google_Protobuf_Value?
}
...
public struct EventStore_Client_Projections_ResultReq {
    ...
    fileprivate var _options: EventStore_Client_Projections_ResultReq.Options?
}
...
public struct EventStore_Client_Projections_ResultResp {
    ...
    public var hasResult: Bool { _result != nil }
    /// Clears the value of `result`. Subsequent reads from it will return its default value.
    public mutating func clearResult() { _result = nil }

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    private var _result: SwiftProtobuf.Google_Protobuf_Value?
}
...
public struct EventStore_Client_Projections_ResetReq {
    ...
    fileprivate var _options: EventStore_Client_Projections_ResetReq.Options?
}
...
public struct EventStore_Client_Projections_EnableReq {
    ...
    fileprivate var _options: EventStore_Client_Projections_EnableReq.Options?
}
...
public struct EventStore_Client_Projections_DisableReq {
    ...
    fileprivate var _options: EventStore_Client_Projections_DisableReq.Options?
}
