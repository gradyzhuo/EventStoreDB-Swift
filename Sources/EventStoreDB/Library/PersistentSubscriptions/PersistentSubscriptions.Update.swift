...
extension PersistentSubscriptions.Update {
    ...
    public enum StreamSelection {
        case all(position: Stream.Cursor<Stream.Read.Position>)
        case specified(streamIdentifier: Stream.Identifier, revision: Stream.Cursor<UInt64>)
        
        func build(options: inout PersistentSubscriptions.Update.Request.UnderlyingMessage.Options) throws{
    ...
    public final class Options: EventStoreOptions {
        ...
        @discardableResult
        public func set(namedConsumerStrategy: PersistentSubscriptions.Update.Request.UnderlyingMessage.ConsumerStrategy)->Self {
            options.settings.namedConsumerStrategy = namedConsumerStrategy
            return self
        }
        
        @discardableResult
        public func setMessageTimeout(_ timeout: PersistentSubscriptions.TimeSpan)->Self {
            switch timeout {
        ...
        @discardableResult
        public func setCheckpoint(after span: PersistentSubscriptions.TimeSpan)->Self {
            switch span {
