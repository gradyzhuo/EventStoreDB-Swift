...
public struct EventStore_Client_PersistentSubscriptions_ReadResp {
  ...
  public enum OneOf_Content: Equatable {
    ...
    public static func ==(lhs: EventStore_Client_PersistentSubscriptions_ReadResp.OneOf_Content, rhs: EventStore_Client_PersistentSubscriptions_ReadResp.OneOf_Content) -> Bool {
      ...
      case (.subscriptionConfirmation, .subscriptionConfirmation): return {
        guard case .subscriptionConfirmation(let l) = lhs, case .subscriptionConfirmation(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
  ...
  public struct ReadEvent {
    ...
    public enum OneOf_Count: Equatable {
      ...
      public static func ==(lhs: EventStore_Client_PersistentSubscriptions_ReadResp.ReadEvent.OneOf_Count, rhs: EventStore_Client_PersistentSubscriptions_ReadResp.ReadEvent.OneOf_Count) -> Bool {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.retryCount, .retryCount): return {
          guard case .retryCount(let l) = lhs, case .retryCount(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.noRetryCount, .noRetryCount): return {
          guard case .noRetryCount(let l) = lhs, case .noRetryCount(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
  ...
  public struct Settings {
    ...
    public enum OneOf_MessageTimeout: Equatable {
      ...
      public static func ==(lhs: EventStore_Client_PersistentSubscriptions_CreateReq.Settings.OneOf_MessageTimeout, rhs: EventStore_Client_PersistentSubscriptions_CreateReq.Settings.OneOf_MessageTimeout) -> Bool {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.messageTimeoutTicks, .messageTimeoutTicks): return {
          guard case .messageTimeoutTicks(let l) = lhs, case .messageTimeoutTicks(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.messageTimeoutMs, .messageTimeoutMs): return {
          guard case .messageTimeoutMs(let l) = lhs, case .messageTimeoutMs(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
    ...
    public enum OneOf_CheckpointAfter: Equatable {
      ...
      public static func ==(lhs: EventStore_Client_PersistentSubscriptions_CreateReq.Settings.OneOf_CheckpointAfter, rhs: EventStore_Client_PersistentSubscriptions_CreateReq.Settings.OneOf_CheckpointAfter) -> Bool {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.checkpointAfterTicks, .checkpointAfterTicks): return {
          guard case .checkpointAfterTicks(let l) = lhs, case .checkpointAfterTicks(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.checkpointAfterMs, .checkpointAfterMs): return {
          guard case .checkpointAfterMs(let l) = lhs, case .checkpointAfterMs(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
  ...
  public struct Options {
    ...
    public enum OneOf_StopAtOption: Equatable {
      ...
      public static func ==(lhs: EventStore_Client_PersistentSubscriptions_ReplayParkedReq.Options.OneOf_StopAtOption, rhs: EventStore_Client_PersistentSubscriptions_ReplayParkedReq.Options.OneOf_StopAtOption) -> Bool {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.stopAt, .stopAt): return {
          guard case .stopAt(let l) = lhs, case .stopAt(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.noLimit, .noLimit): return {
          guard case .noLimit(let l) = lhs, case .noLimit(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
  ...
  public struct Options {
    ...
    public enum OneOf_ListOption: Equatable {
      ...
      public static func ==(lhs: EventStore_Client_PersistentSubscriptions_ListReq.Options.OneOf_ListOption, rhs: EventStore_Client_PersistentSubscriptions_ListReq.Options.OneOf_ListOption) -> Bool {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.listAllSubscriptions, .listAllSubscriptions): return {
          guard case .listAllSubscriptions(let l) = lhs, case .listAllSubscriptions(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.listForStream, .listForStream): return {
          guard case .listForStream(let l) = lhs, case .listForStream(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
